          ...
          <div className="bag__cart-selected">
            ...
            <div className="bag__cart-head">
              ...
              <div className="bag__cart-remove">
                <button className="txt-uppercase">remove</button>
                <button className="txt-uppercase">Move to wishlist</button>
              </div>
            </div>
                ...
                return (
                  <div className="bag__cart-singleProduct" key={key}>
                    ...
                    <div className="singleProduct-content">
                      ...
                      <p id="company">Sold by: LANDMARK ONLINE INDIA PVT LTD</p>
                      <p id="quantity">
                        <span>Qty: </span>
                        {item.quantity}
